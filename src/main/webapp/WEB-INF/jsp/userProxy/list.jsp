            ...
            <div class="layui-field-box">
				<div>
				  <c:import url="search.jsp">
						<c:param name="action" value="${pageContext.request.contextPath}/userProxy/list"/>
				  </c:import>
				</div>
...
<div class="operator">
   <c:import url="../common/button.jsp">
         <c:param name="create">${pageContext.request.contextPath }/userProxy/create</c:param>
         <c:param name="modify">${pageContext.request.contextPath }/userProxy/modify</c:param>
         <c:param name="delete">${pageContext.request.contextPath }/userProxy/delete</c:param>
