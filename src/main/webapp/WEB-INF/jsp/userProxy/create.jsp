    ...
    <fieldset class="layui-elem-field">
        ...
        <div class="layui-field-box">
            <form class="layui-form layui-form-pane"
                  action="${pageContext.request.contextPath }/userProxy/save?queryStr${queryStr}" id="userForm"
                  method="post">
                <input type="hidden" value="${form.id }" name="id">
                <div class="layui-form-item">
                    <label class="layui-form-label">账号:</label>
                    <div class="layui-input-inline">
                        <input type="text" name="username" id="username" value="${form.username}" lay-verify="username"
                               placeholder="请输入账号名称" class="layui-input create-input">
                ...
                <div class="layui-form-item password">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="passwd" id="passwd" value="${form.passwd}" lay-verify="passwd"
                               placeholder="请输入密码" class="layui-input create-input">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="email" value="${form.email }" placeholder="请输入邮箱" lay-verify="email"
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="mobile" id="mobile" value="${form.mobile }" placeholder="请输入手机号码"
                               lay-verify="mobile" class="layui-input create-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">角色:</label>
                    <div class="layui-input-block">
                        <select id="role" name="role" lay-verify="role" xm-select="role" xm-select-skin="danger"
                                xm-select-search="">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block create-radio" id="gender">
                        ...
                        <c:if test="${form.gender eq 0}"> checked</c:if> checked>
                        <input type="radio" name="gender" title="男" value="1"
                        <c:if test="${form.gender eq 1}"> checked</c:if> >
                        <input type="radio" name="gender" title="保密" value="2" <c:if test="${form.gender eq 2}">
                               checked</c:if>>
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block create-radio" id="status">
                        ...
                        <c:if test="${form.status eq 0}"> checked</c:if> checked>
                        <input type="radio" name="status" value="1" title="可用"  <c:if test="${form.status eq 1}">
                               checked</c:if>>
                    </div>
                </div>
                <div class="layui-form-item">
...
<script>
    ...
    var role = "${role}";
    $.getJSON('${pageContext.request.contextPath }/role/queryAllRole', function (result) {
        if (result) {
            ...
            layui.use(['form', 'jquery', 'formSelects'], function () {
                ...
                if (role != '' && role != null) {
                    ...
                    for (var i = 0; i < roles.length; i++) {
                        formSelects.value('role', [roles[i]], true);
                    }
                }
            })
        }
