...
<div>
    ...
    <fieldset class="layui-elem-field fieldset">
        ...
        <div class="layui-field-box">
            <form class="layui-form layui-form-pane" action="${pageContext.request.contextPath }/user/save?queryStr${queryStr}" id="userForm" method="post">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <select id="role" name="role" lay-verify="role" xm-select="role" xm-select-skin="danger" xm-select-search="">
