...
<table id="table">
    <tr>
        <td >
            <form class="layui-form" action="${pageContext.request.contextPath }/user/list" method="post">
                <div class="layui-inline">
                    <div class="search-name" style="width: 40px">账号:</div>
                    <div class="layui-input-inline">
                        <input type="text" class="layui-input" name="username" value="${param.username }" placeholder="请输入账号名称">
                    </div>
                </div>
                <div class="layui-inline">
