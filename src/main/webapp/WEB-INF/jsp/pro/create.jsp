            ...
            <form class="layui-form" id="myform" name="myform" action="" method="post" enctype="multipart/form-data">
                ...
                <div class="layui-form-item layui-form-pro-list">
                    ...
                    <div class="layui-input-block">
                        <select id="pro_list" name="pro_list" lay-verify="pro_list" lay-search  lay-verify="required" placeholder="请输入产品分类">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="freight" class="layui-input" value="${form.freight}"
                               placeholder="请输入预售价" style="float: left;width: 290px">
                    </div>
                </div>
                ...
                <div class="layui-input-block" style="width: 289px;border: 1px solid gainsboro">
                    <input type="radio" name="status" value="1" title="通过"<c:if test="${form.status eq 1}"> checked</c:if>>
                    <input type="radio" name="status" value="2" title="不通过"  <c:if test="${form.status eq 2}"> checked</c:if>>
                    <input type="radio" name="status" value="3" title="未审核"  <c:if test="${form.status eq 3}"> checked</c:if> checked>
                </div>
            </div>
                </c:if>
                <div class="layui-form-item">
