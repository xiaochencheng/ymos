...
<head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/jsandcss/layui/layui/layui.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/jsandcss/js/zhsp/form.js"></script>
</head>
<body>
