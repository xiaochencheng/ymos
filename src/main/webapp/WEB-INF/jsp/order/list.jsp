                        ...
                        <table class="layui-table" lay-size="sm">
                            ...
                            <c:forEach items="${datas}" var="data">
                                <tr>
                                    ...
                                    <td>${data.ygly}</td>
                                    <td>${data.shrname}【${data.chCountry}】</td>
                                    <td>${data.mjzdwl}</td>
                                    <td>${data.orderId}</td>
                                    <td>${data.ydh}</td>
                                    <td>付款时间：${data.fksj}</td>
                                    <td>
                                     ${data.orderStatus}
                                    </td>
    ...
    function browses(ydh) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                /*var deliver1 =
                    '<li class="first"><i class="node-icon"></i><span class="time">' +obj1.trackinfo[0].Date + '</span>' ||
                    '<span class="txt">' +obj1.trackinfo[0].StatusDescription+'</span></li>';
