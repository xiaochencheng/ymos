...
public class ReviewForm extends IdForm<Review> {
    ...
    @Override
    public Review newObj() {
        return new Review();
    }

    @Override
    public void formObj(Review review) {
        review.setCus_ch_name(cus_ch_name);
        review.setCus_en_name(cus_en_name);
        review.setCus_price(cus_price);
        review.setCus_weight(cus_weight);
        review.setPresale_price(presale_price);
        review.setPro_list(pro_list);
        review.setPro_ch_name(pro_ch_name);
        review.setPro_en_name(pro_en_name);
        review.setPro_url(pro_url);
        review.setUrl(url);
        review.setUrl2(url2);
        review.setUrl3(url3);
