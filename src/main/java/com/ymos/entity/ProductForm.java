...
public class ProductForm extends IdForm<Product> {
    ...
    @Override
    public void formObj(Product product) {

        product.setCus_ch_name(cus_ch_name);
        product.setCus_en_name(cus_en_name);
        product.setCus_price(cus_price);
        product.setCus_weight(cus_weight);
        product.setPresale_price(presale_price);
        product.setPro_list(pro_list);
        product.setPro_ch_name(pro_ch_name);
        product.setPro_en_name(pro_en_name);
        product.setPro_url(pro_url);
        product.setUrl(url);
